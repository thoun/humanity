...
$this->EXPERIMENT = [
    1 => [
        ...
        2 => new ExperimentType(CENTRAL, [INSECT => 1, METHANE => 1], 2, EXPERIMENT_POWER_TIME),
        3 => new ExperimentType(LEFT, [ICE => 1, METHANE => 1], 2, EXPERIMENT_POWER_TIME),
        4 => new ExperimentType(RIGHT, [INSECT => 1, METHANE => 1], 4),
        5 => new ExperimentType(LEFT, [INSECT => 1, METHANE => 1], 2, EXPERIMENT_POWER_REACTIVATE),
        6 => new ExperimentType(LEFT, [INSECT => 1, ICE => 1], 4),
        7 => new ExperimentType(CENTRAL,[ICE => 1, METHANE => 1], 4),
        8 => new ExperimentType(RIGHT, [ICE => 1, METHANE => 1], 2, EXPERIMENT_POWER_REACTIVATE),
    ...
    3 => [
        1 => new ExperimentType(LEFT, [OXYGEN => 1, METHANE => 1], 6, null, 1),
        2 => new ExperimentType(LEFT, [PROTEIN => 1, METHANE => 1], 4, EXPERIMENT_POWER_REACTIVATE, 1),
        3 => new ExperimentType(LEFT, [AIRCARBON => 1, METHANE => 1], 4, EXPERIMENT_POWER_TIME, 1),
...
$this->MODULES = [ //public int $type; // 0 start, 1..3 year, 8 communication, 9 obstacle
    0 => [ // start
        ...
        3 => new OrangeModuleType([], 1, [METHANE]),
        4 => new BlueModuleType([], 2, [ELECTRICITY]),
    ],
    ...
    1 => [
        ...
        4 => new OrangeModuleType([ICE => 2], 1, [INSECT, METHANE]),
        5 => new OrangeModuleType([METHANE => 2], 1, [INSECT, ICE]),
        6 => new OrangeModuleType([INSECT => 2], 1, [METHANE, ICE]),
        7 => new BlueModuleType([ICE => 3], 2, [OXYGEN]),
        8 => new BlueModuleType([METHANE => 3], 2, [AIRCARBON]),
        9 => new BlueModuleType([INSECT => 3], 2, [PROTEIN]),
        10 => new PurpleModuleType([ELECTRICITY => 1, METHANE => 1], 3, 2, GREEN),
        11 => new PurpleModuleType([ELECTRICITY => 1, ICE => 1], 3, 2, BLUE),
        12 => new PurpleModuleType([ELECTRICITY => 1, INSECT => 1], 3, 2, ORANGE),
        13 => new GreenModuleType([ICE => 2], SHAPE_OCTAGONAL),
        14 => new GreenModuleType([METHANE => 2], SHAPE_RECTANGULAR),
    ...
    2 => [
        ...
        6 => new BlueModuleType([INSECT => 2, ICE => 2], 2, [PROTEIN, OXYGEN]),
        7 => new BlueModuleType([ICE => 2, METHANE => 2], 2, [AIRCARBON, OXYGEN]),
        8 => new BlueModuleType([INSECT => 2, METHANE => 2], 2, [PROTEIN, AIRCARBON]),
        9 => new PurpleModuleType([ELECTRICITY => 1, PROTEIN => 1], 4, 1, ORANGE),
        10 => new PurpleModuleType([ELECTRICITY => 1, INSECT => 1, ICE => 1, METHANE => 1], 3, 2, ANY_COLOR),
        ...
        14 => new GreenModuleType([OXYGEN => 1], SHAPE_OCTAGONAL),
        15 => new GreenModuleType([AIRCARBON => 1], SHAPE_RECTANGULAR),
    ],

    3 => [
        1 => new ModuleType(BLUE_OR_ORANGE, [INSECT => 1, OXYGEN => 1, METHANE => 1], null, null, 0, 5),
        2 => new OrangeModuleType([PROTEIN => 1, ICE => 1], null, null, null, 1),
        3 => new OrangeModuleType([OXYGEN => 1, METHANE => 1], null, null, null, 1),
        ...
        7 => new BlueModuleType([PROTEIN => 1, METHANE => 1], null, null, null, 1),
        8 => new PurpleModuleType([ELECTRICITY => 1, OXYGEN => 1, METHANE => 1], 5, 0, BLUE),
        ...
        11 => new PurpleModuleType([ELECTRICITY => 1, PROTEIN => 1, METHANE => 1], 4, 1, ANY_COLOR),
        12 => new GreenModuleType([OXYGEN => 1, ICE => 1], SHAPE_OCTAGONAL, 1),
        13 => new GreenModuleType([AIRCARBON => 1, METHANE => 1], SHAPE_RECTANGULAR, 1),
...
$this->MISSIONS = [
    ...
    3 => [
        ...
        2 => new MissionTypeC(4, METHANE, null),
