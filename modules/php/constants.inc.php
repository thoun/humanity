...
const ST_PLAYER_CHOOSE_RADAR_COLOR = 11;
...
const ST_PLAYER_UPGRADE_WORKER = 50;

const ST_CHECK_OBJECTIVES = 80;

const ST_NEXT_PLAYER = 85;

const ST_END_ROUND = 90;
const ST_MULTIPLAYER_MOVE_WORKERS = 91;
const ST_PRIVATE_MOVE_WORKER = 92;
const ST_PRIVATE_CONFIRM_MOVE_WORKERS = 93;
...
const MOVED_WORKERS = 'MOVED_WORKERS';
